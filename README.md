...
This application is hosted by Heroku, and you can visit it through the following link:: 
...
The application controls if there are any errors in the api calls.
...
Example 3: If it is an invalid date in the call.

```

curl https://weather-information-api.herokuapp.com/weather/summary/berlin/20193454/1800/
...
Example 4: If the detailed information in the call has an invalid name.
...
Example 5: If the city in the call has an invalid name.

```
curl https://weather-information-api.herokuapp.com/weather/temperature/be/20190526/1800/
